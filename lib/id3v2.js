...
(function (globalObject, createModule) {
    ...
    //
    mp3Id3v2Parser.readFrameContent = {};
    ...
    mp3Id3v2Parser.readFrameContent.T = function (view, offset, length) {
    ...
    mp3Id3v2Parser.readFrameContent.TXXX = function  (view, offset, length) {
        var
    ...
    //
    // * URL: a text string
    mp3Id3v2Parser.readFrameContent.W = function (view, offset, length) {
    ...
    // * Description: a text string according to encoding (followed by 00 (00))
    // * URL:         a text string
    mp3Id3v2Parser.readFrameContent.WXXX = function (view, offset, length) {
        var
            // The content to be returned
            content = { encoding: view.getUint8(offset) },
    ...
    mp3Id3v2Parser.readFrameContent.COMM = function (view, offset, length) {
        var
            // The content to be returned
            content = { encoding: view.getUint8(offset) },
    ...
    mp3Id3v2Parser.readFrameContent.UFID = function (view, offset, length) {
        var
    ...
    mp3Id3v2Parser.readFrameContent.IPLS = function (view, offset, length) {
        var
            // The content to be returned
            content = {
    ...
    // * Language:    3 digit (octet) lang-code (ISO-639-2)
    // * Actual text: a text string according to encoding
    mp3Id3v2Parser.readFrameContent.USER = function (view, offset, length) {
        var
            // The content to be returned
            content = { encoding: view.getUint8(offset) },
    ...
    mp3Id3v2Parser.readFrameContent.PRIV = function (view, offset, length) {
        var
            // Read up to the first null terminator to get the owner-identifier
            ownerIdentifier = lib.readTrmStr.iso(view, offset, length),
    ...
    mp3Id3v2Parser.readFrameContent.PCNT = function (view, offset, length) {
    ...
    // * Counter:       4 octets (at least ..)
    mp3Id3v2Parser.readFrameContent.POPM = function (view, offset, length) {
        var content = {
    ...
    mp3Id3v2Parser.readFrameContent.APIC = function (view, offset, length) {
        var
            // The content to be returned
            content = { encoding: view.getUint8(offset) },
    ...
    mp3Id3v2Parser.readId3v2TagFrame = function (view, offset) {
        ...
        var frame = {
            ...
            readFrameContent = (function (read, id) {
                ...
                //  `undefined` as the frame's content) if no implementation found
                return read[id] || lib.noOp;
            }(mp3Id3v2Parser.readFrameContent, frame.header.id));
        ...
        frame.content = readFrameContent(view, offset + 10, frame.header.size);
