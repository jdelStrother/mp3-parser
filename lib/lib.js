...
(function (globalObject, createModule) {
    ...
    */
    ...
    lib.readFrameHeader = function (view, offset) {
        ...
        b2 = view.getUint8(offset + 1);
        b3 = view.getUint8(offset + 2);
        b4 = view.getUint8(offset + 3);
    ...
    lib.readFrame = function (view, offset, requireNextFrame) {
        ...
        //
        frame._section.byteLength = lib.getFrameByteLength(frame.header.bitrate,
            frame.header.samplingRate, frame.header.framePadding);
        ...
        if (lib.isSeq(lib.seq.xing, view, offset + 36) ||
            lib.isSeq(lib.seq.info, view, offset + 36)) {
            return null;
        }
